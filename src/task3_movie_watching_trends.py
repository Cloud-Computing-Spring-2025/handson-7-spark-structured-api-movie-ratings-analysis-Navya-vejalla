...
def analyze_movie_watching_trends(df):
    ...
    # Order the results by `WatchedYear`
...
def main():
    ...
    output_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-Navya-vejalla/Outputs/movie_watching_trends.csv"
